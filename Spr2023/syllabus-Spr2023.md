...
### Course Delivery:
This course will be delivered in person. You can access the course materials, quizzes, assignments, and other additional resources from D2L. [Piazza](https://piazza.com/msu/spr2022/cse840/home) will be used as the discussion forum for students to ask questions. 
...
- **Attendance:** Students are expected to attend all the lectures and must inform the instructor if they are unable to do so due to emergency or other legitimate reasons (e.g., quarantine due to having symptoms of Covid-19). **Any student who miss 5 lectures (20% of the class) or more without prior approval** from the instructor will get 5% deducted from their overall final grade. 
