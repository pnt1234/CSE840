## CSE840: Computational Foundations in Artificial Intelligence (Spring 2024)
---
...
- Instructor's office hours: Mon, Wed 2:40-3:40pm in EB 2129
...
- TA's office hours: Tue: 3:30-4:30pm (Ramin), Thur: 4-5pm (Mashrur), Fri: 3-4pm (Ramin) and 5-6pm (Mashrur) in EB 3203
...
- **ChatGPT and LLMs:** You should not rely on the answers provided by chatGPT or other large language models when solving assignment problems as their results are often incomplete or incorrect (especially when solving math calculation problems). If you indeed use such tools, you should provide an acknowledgment to explain which part of the answer is obtained from using such a tool.
