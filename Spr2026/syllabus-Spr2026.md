## CSE840: Computational Foundations in Artificial Intelligence (Spring 2025)
---
...
- Instructor's office hours: Mon 2:45-3:35pm and Fri 8:30-9:30am in EB 2129 or via [[zoom](https://msu.zoom.us/j/92931714382)] (Passcode: 903041)
...
- Successfully complete the quizzes, homework assignments, and exams. 

### Course Requirements:
-	Access to [Desire2Learn](https://d2l.msu.edu) (D2L) and [Piazza](https://piazza.com/msu/spring2026/cse840/home). 
-	Laptop or desktop computer with capabilities to write and execute python programs. 

### Course Delivery:
This course will be delivered in person. You can access the course materials, quizzes, assignments, and other additional resources from D2L. [Piazza](https://piazza.com/msu/spring2026/cse840/home) will be used as the discussion forum for students to ask questions. 
...
A tentative class schedule can be found [here](https://pnt1234.github.io/CSE840/Spr2026/schedule-Spr2026)
...
### Important Dates:
The last day for online add period is Jan 16. The last day to drop this course with tuition refund is Feb 5. Middle of the semester and last date to drop with no grade reported is March 9. 
...
- Jan 19: No class (due to MLK day)
- Feb 28 - Mar 8: Spring break

### Course Policies:

- **Attendance:** Students are expected to attend all the lectures. Failure to attend more than 5 lectures without prior permission from the instructor will result in penalty to their final grade (i.e., loss of 5% attendance grade).
- **Online Quizzes:** Online quizzes will be available on D2L and must be completed before midnight on Sunday of the assigned week (unless stated otherwise). **No extension will be given.** You are allowed up to 3 attempts per quiz (only the highest grade for each quiz will be recorded). Only the top-8 highest quiz scores will count toward your final grade.
...
- **Exam Information:** All exams are open book and notes (but no laptop or other electronic devices except for calculators). The final exam is scheduled to be held on **Monday (Apr 27) from 12:45PM-2:45PM.** Make-up examination can be arranged if your absence is due to conference travel, documented illness, or personal emergency. A written explanation (including supporting documentation) must be submitted to the instructor; if the explanation is acceptable, an alternative to the examination will be arranged. Except for emergency cases, make-up arrangements must be made in advance, at least a week before the scheduled exam. 
- **Discussion Forum:** We will be using [Piazza](https://piazza.com/msu/spring2026/cse840/home) for class discussion. Rather than emailing class-related questions to the instructor, you are encouraged to post them on Piazza. Do not post your partial solution (e.g., snippets of your code) or attempted solution (e.g., for assignments) on Piazza. In addition, you must not post the course materials (including slides, quizzes, homework assignments, exam, and their solutions) on any other websites without permission from the instructor. You are also prohibited from soliciting help by posting quiz and homework questions online on websites such as Chegg, Brainly, Quizlet, and other similar websites. You may discuss how to solve a problem with your fellow students but must not share your actual solution with them. Violation of the policy will result in an Academic Dishonesty Report (ADR) filed and a zero grade for the entire quiz or assignment. The ADR for students who continue to post questions from assignments or quizzes to these sites will lead to additional sanctions, including an automatic failing grade of zero (0.0) for the course.
- **ChatGPT and LLMs:** You may use LLM to assist you with learning the materials but should not rely on the answers provided by chatGPT or other large language models when solving assignment problems as their results are often incomplete or incorrect due to hallucination (especially when solving math problems). If you indeed use such tools, you should provide an acknowledgment to explain which part of the answer is obtained from using such a tool. Failure to acknowledge the use of LLM (or other online sources) to solve your assignment and if a similar solution was found for another student, it may be treated as a case of plagiarism or cheating.
- **Study Groups:** You are allowed to form study groups to learn the materials in class. However, you are forbidden from sharing the solution of your quizzes and homework assignments with other students.  This includes sharing your solution with another student to double-check answers. All submitted assignments (quizzes, homeworks, and exams) must be your own work.**Students who were found sharing, plagirizing, or copying the solution of other student(s) will automatically receive a zero for the entire assignment.* In addition, an Academic Dishonesty Report will be filed and submitted to the university.
- **Resources for Persons with Disabilities (RCPD):** Michigan State University is committed to providing equal opportunity for participation in all programs, services and activities. Requests for accommodations by persons with disabilities may be made by contacting the Resource Center for Persons with Disabilities at 517-884-RCPD or on the web at rcpd.msu.edu. Once your eligibility for an accommodation has been determined, you will be issued a verified individual services accommodation (“VISA”) form. Please present this form to me at the start of the term and/or two weeks prior to the accommodation date (exam and homework). To make an appointment with a specialist, contact:  (517) 353-9642 or TTY:  (517) 355-1293. The website for RCPD is located at [http://MYProfile.rcpd.msu.edu](http://MYProfile.rcpd.msu.edu).
